...
apt-get install dnsmasq ssh systemd nano apache2 php8.2 apache2-mod_php8.2 mariadb-server php8.2-
...
php8.2-xmlreader php8.2-fileinfo php8.2-sodium nfs-server -y
systemctl enable --now dnsmasq sshd httpd2 mysqld nsf-server
